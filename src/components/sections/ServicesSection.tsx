...
const services = [
  ...
  },
  {
    ...
    price: "R$ 80,00",
    icon: Shield,
    features: ["Lavagem completa", "Cera premium", "Limpeza motor", "Pneus e aros"],
    popular: false
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            ...
            com profissionais qualificados e produtos de alta qualidade.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => {
            ...
            return (
              <Card key={service.id} className="relative bg-gradient-card hover:shadow-medium transition-all duration-300 group">
                {service.popular && (
